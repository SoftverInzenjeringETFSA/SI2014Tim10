 ...
 * @author ZUGOR
 */
public class BilansStanjaFrame extends javax.swing.JFrame {

    /**
     * Creates new form BilansStanjaFrame
     */
    public BilansStanjaFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Redni broj", "Aktiva (duguje)", "Iznos", "Redni broj", "Pasiva (Potrazuje)", "Iznos"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Object.class, java.lang.Float.class, java.lang.Integer.class, java.lang.Object.class, java.lang.Float.class
            };
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BilansStanjaFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BilansStanjaFrame().setVisible(true);
            }
        });
    }
