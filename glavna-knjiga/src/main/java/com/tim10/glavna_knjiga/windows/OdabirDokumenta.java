 ...
 * @author Omar
 */
public class OdabirDokumenta extends javax.swing.JFrame {

    private Stavka _parent;
    private List<Dokumenti> _dokumenti = new ArrayList<Dokumenti>();
    private NaloziUtils _utils = NaloziUtils.getInstace();
    /**
     * Creates new form OdabirDokumenta
     */
    public OdabirDokumenta() {
        initComponents();
    }
    
    public OdabirDokumenta(Stavka parent) {
        initComponents();
    ...
    private void btnOdaberiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOdaberiActionPerformed
        ...
        if (selectedRow != -1)
        {
            Dokumenti dokument = _dokumenti.get(selectedRow);
            
            _parent.setDokument(dokument);
            
            this.dispose();
        }
        else
        {
            setErrorMsg("Potrebno je odabrati dokument.");
        }
    }//GEN-LAST:event_btnOdaberiActionPerformed

    private void getDokumenti() {
        _dokumenti = _utils.getDokumenti();
        
        if (_dokumenti.size() > 0)
        {
            updateTable();
        }
        else
    ...
    private void updateTable() {
        ...
        for(Dokumenti dokument: _dokumenti)
        {
            dataRow = new Object[]{
                dokument.getId(),
                dokument.getNaziv(),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OdabirDokumenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OdabirDokumenta().setVisible(true);
            }
        });
    }
